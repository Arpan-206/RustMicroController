...
#
# riscv.tcl: Tcl script for re-creating project 'RISCV_Dual'
#
# Generated by Vivado on Fri Jan 17 14:16:08 GMT 2025
...
#
# 1. This project restoration tcl script (riscv.tcl) that was generated.
#
...
proc loadUserFiles { origin_dir dir } {

  foreach file [glob -nocomplain $dir] {

    set normalizedFile "[file normalize "$file"]"

    set normalizedFile [import_files -fileset sources_1 $normalizedFile]
 
    set file_obj [get_files -of_objects [get_filesets sources_1] $normalizedFile] 
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/rtl/processor/header.v"]"\
 "[file normalize "$origin_dir/rtl/processor/SRAM_ctrl.v"]"\
 "[file normalize "$origin_dir/rtl/processor/UART.v"]"\
 "[file normalize "$origin_dir/rtl/processor/csr.v"]"\
 "[file normalize "$origin_dir/rtl/processor/decode.v"]"\
 "[file normalize "$origin_dir/rtl/processor/execute.v"]"\
 "[file normalize "$origin_dir/rtl/processor/fetch.v"]"\
 "[file normalize "$origin_dir/rtl/processor/fifo_uart.v"]"\
 "[file normalize "$origin_dir/rtl/processor/illegal.v"]"\
 "[file normalize "$origin_dir/rtl/processor/interrupts_m.v"]"\
 "[file normalize "$origin_dir/rtl/processor/interrupts_s.v"]"\
 "[file normalize "$origin_dir/rtl/processor/lcd_pio.v"]"\
 "[file normalize "$origin_dir/rtl/processor/led_pio.v"]"\
 "[file normalize "$origin_dir/rtl/processor/master_io.v"]"\
 "[file normalize "$origin_dir/rtl/processor/memory.v"]"\
 "[file normalize "$origin_dir/rtl/processor/misc_io.v"]"\
 "[file normalize "$origin_dir/rtl/processor/mmu.v"]"\
 "[file normalize "$origin_dir/rtl/processor/multiply.v"]"\
 "[file normalize "$origin_dir/rtl/processor/pio.v"]"\
 "[file normalize "$origin_dir/rtl/processor/registers.v"]"\
 "[file normalize "$origin_dir/rtl/processor/risc_v.v"]"\
 "[file normalize "$origin_dir/rtl/processor/store_just.v"]"\
 "[file normalize "$origin_dir/rtl/processor/timer.v"]"\ 
 "[file normalize "$origin_dir/rtl/processor/vduc.v"]"\
 "[file normalize "$origin_dir/rtl/processor/write.v"]"\
 "[file normalize "$origin_dir/rtl/memory/system.v"]"\ 
 "[file normalize "$origin_dir/rtl/memory/master.coe"]"\
 "[file normalize "$origin_dir/rtl/memory/slave.coe"]"\ 
 "[file normalize "$origin_dir/rtl/processor/video_buff.v"]"\ 
 "[file normalize "$origin_dir/ip/blk_mem_gen_2/blk_mem_gen_2.xci"]"\
 "[file normalize "$origin_dir/ip/clk_wiz_0/clk_wiz_0.xci"]"\
 "[file normalize "$origin_dir/ip/blk_mem_gen_3_1/blk_mem_gen_3.xci"]"\
 "[file normalize "$origin_dir/ip/blk_mem_gen_1/blk_mem_gen_1.xci"]"\
 "[file normalize "$origin_dir/constraints/new/top_timing.xdc"]"\
 "[file normalize "$origin_dir/constraints/new_lab_board_constraints_v1.2.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "RISCV_Dual"
...
set orig_proj_dir "[file normalize "$origin_dir/../../riscv_firmware/hardware/RISCV_Dual"]"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7s50fgga484-2

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Load user custom files
# Incluede Verilog and
#          System Verilog
loadUserFiles $origin_dir "./rtl/user/*.v"
loadUserFiles $origin_dir "./rtl/user/*.sv"
...
set_property -name "part" -value "xc7s50fgga484-2" -objects $obj
...
set_property -name "webtalk.activehdl_export_sim" -value "95" -objects $obj
set_property -name "webtalk.ies_export_sim" -value "91" -objects $obj
set_property -name "webtalk.modelsim_export_sim" -value "95" -objects $obj
set_property -name "webtalk.questa_export_sim" -value "95" -objects $obj
set_property -name "webtalk.riviera_export_sim" -value "95" -objects $obj
set_property -name "webtalk.vcs_export_sim" -value "95" -objects $obj
set_property -name "webtalk.xsim_export_sim" -value "95" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/rtl/processor/vduc.v"]\
 [file normalize "${origin_dir}/rtl/processor/write.v"]\
 [file normalize "${origin_dir}/rtl/processor/system.v"]\
 [file normalize "${origin_dir}/rtl/memory/master.coe"]\
 [file normalize "${origin_dir}/rtl/memory/slave.coe"]\
 [file normalize "${origin_dir}/rtl/processor/video_buff.v"]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/ip/blk_mem_gen_3/blk_mem_gen_3.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
set file "[file normalize ${origin_dir}/constraints/top_timing.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "top_timing.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/constraints/new_lab_board_constraints_v1.2.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new_lab_board_constraints_v1.2.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/constraints/new_lab_board_constraints_v1.2.xdc" -objects $obj
set_property -name "target_part" -value "xc7s50fgga484-2" -objects $obj
set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/constraints/new_lab_board_constraints_v1.2.xdc" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7s50fgga484-2 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s50fgga484-2 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7s50fgga484-2 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "ml_strategy_runs" -value "" -objects $obj
set_property -name "auto_rqs" -value "0" -objects $obj
set_property -name "auto_rqs.directory" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/impl_2" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
...
# Update Slave COE file
set_property -dict [list \
  CONFIG.Coe_File [ get_files "slave.coe"] \
  CONFIG.Load_Init_File {true} \
] [get_ips blk_mem_gen_2]

# Update Master COE file
set_property -dict [list \
  CONFIG.Coe_File [ get_files "master.coe" ] \
  CONFIG.Load_Init_File {true} \
